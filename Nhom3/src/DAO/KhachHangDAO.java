...
public class KhachHangDAO implements HairSalonDAO<KhachHang, String>{
    ...
    String update = "update khachhang set  hoten=?,sodienthoai=?,email=?,gioitinh=?,diachi=?,ghichu=?"
            + " where  makhachhang=?"  ;
    ...
    public void insert(KhachHang model) {
        try {
            JdbcHelper.executeUpdate(insert, model.getMaKhachHang(),
                    model.getHoTen(),model.getSoDienThoai(),
                    model.getEmail(),model.getGioiTinh(),model.getDiaChi(),model.getGhiChu());
    ...
    public void update(KhachHang model) {
        try {
            JdbcHelper.executeUpdate(update, model.getHoTen(),model.getSoDienThoai(),
                    model.getEmail(),model.getGioiTinh(),model.getDiaChi(),model.getGhiChu(),model.getMaKhachHang());
        } catch (SQLException ex) {
            Logger.getLogger(KhachHangDAO.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
